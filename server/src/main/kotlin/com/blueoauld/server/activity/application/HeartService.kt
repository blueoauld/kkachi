...
class HeartService(
    ...
    private fun toCursorResponse(results: List<ActivityResult>, size: Int): CursorResponse<HeartResponse> {
        return CursorResponse.of(results, size, { it.id }) { heart ->
            HeartResponse(
                heartId = heart.id,
                ...
                gender = heart.gender,
                age = AgeCalculator.fromBirthYear(heart.birthYear),
